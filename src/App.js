...
function App() {
  ...
  const headers2 = ['N Document', 'Rank','Title']
  ...
  return (
    <section className='app'>
      ...
      <div className='tabla-inside'>
        {!isfirstOpen1 && <h3>Postgres</h3>}
        {!isfirstOpen1 && (<Tabla headers={headers} data={data1}/>)}
      ...
      <div className='tabla-inside'>
        {!isfirstOpen2 && <h3>Python</h3>}
        {!isfirstOpen2 && (<Tabla headers={headers2} data={data2}/>)}
        <span>Elapsed Time: {elapsedTime} seconds</span>
        {isRunning2 && (
          <PacmanLoader color='#36D7B7' size={25}/>
        )}
